...
class Memory:
    ...
    def __init__(self, size):
        ...
        Dequeue 형태 자료구조. S, A, R, S', T를 저장하며, 최대 사이즈 도달 시 currentPosition을 증가시켜 가장 나중의 데이터를 배제하는 구조. 메모리보다 속도 우선
        """
        self.size = size
...
for epoch in range(epochs):
    ...
    for t in range(steps):
        ...
        newObservation, reward, terminated, truncated, info = env.step(action)
